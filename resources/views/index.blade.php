...
<div class="container">
    <div class="soc col-md-12">
        <img src="{{ Vite::asset('resources/images/bizPic2.jpg') }}" style="border: none; width: 50%;">
    </div>
</div>
...
<div id="about">
    ...
    <div class="container">
        <div class="soc col-md-12">
            <h4 style="font-size:27px;">Never miss a class using the MINDBODY app click Get MINDBODY button below!</h4>
            <br>
    ...
    <div class="container ">
        <div class="row team">
            <div class="col-md b1">
                ...
                <h4 style="font-size:27px;"><b>What is hot yoga?</b></h4>
                ...
                <h4 style="font-size:27px;"><b>About</b></h4>
                <p> 
    ...
    <div class="container ">                    
        <div class="row team">                        
            <div class="col-md b1"> 
                <img class="img-responsive" src="{{ Vite::asset('resources/images/debv.jpg') }}">                           
                <h4>Debra Vieira</h4>
            ...
            <div class="col-md b1"> 
                <img class="img-responsive" src="{{ Vite::asset('resources/images/josh.jpg') }}">                           
                <h4>Josh Kane</h4>
                <h5>Yoga Instructor</h5>
